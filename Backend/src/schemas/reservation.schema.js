...
export const createReservationSchema = z.object({
  body: z.object({
    ...
    contact: z.string({ required_error: 'El contacto (teléfono/email) es requerido' }).max(50),
    ...
    diners: z.number({ required_error: 'El número de comensales es requerido' }).int().positive('El número de comensales debe ser mayor a cero'),
  }),
});
